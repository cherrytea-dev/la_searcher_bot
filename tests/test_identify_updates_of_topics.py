...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('John Doe, 30 лет, Москва', 'Москва, Россия'),
        ('John Doe, 30 лет, Москва', 'Москва, Россия'),
        ('John Doe, 30 лет, Москва, Россия', 'Москва, Россия, Россия'),
        ('John Doe, 30 лет, г.о. Москва', 'городской округ Москва, Россия'),
        ('John Doe, 30 лет, м.о. Москва', 'муниципальный округ Москва, Россия'),
        ('John Doe, 30 лет, мкрн Москва', 'Москва, Россия'),
        ('John Doe, 30 лет, мкр Москва', 'Москва, Россия'),
        ('John Doe, 30 лет, р-н Москва АО', 'район Москва , Россия'),
        ('John Doe, 30 лет, р-на Москва', 'район Москва, Россия'),
        ('John Doe, 30 лет, обл. Москва', 'область Москва, Россия'),
        ('John Doe, 30 лет, НСО Москва', 'Новосибирская область Москва, Россия'),
        ('John Doe, 30 лет, МО Москва', 'МО Москва, Россия'),
        ('John Doe, 30 лет, ЛО Москва', 'ЛО Москва, Россия'),
        ('John Doe, 30 лет, г.Сочи Москва', 'Сочи Москва, Россия'),
        ('John Doe, 30 лет, района Москва', 'района Москва, Россия'),
        ('John Doe, 30 лет, области Москва', 'области Москва, Россия'),
        ('John Doe, 30 лет, г. Москва', 'Москва, Россия'),
        ('John Doe, 30 лет, г.москва', 'москва, Россия'),
        (
            'John Doe, 30 лет, г. Сольцы, Новгородская обл. – г. Санкт-Петербург',
            'Сольцы, Новгородская область – г. Санкт-Петербург, Россия',
        ),
        ('John Doe, 30 лет, Орехово-Зуевский район', 'Орехово-Зуевский район, Россия'),
        ('John Doe, 30 лет, СНТ Нефтяник', 'СНТ Нефтянник, Россия'),
        ('John Doe, 30 лет, Коченевский', 'Коченевский, Россия'),
        ('John Doe, 30 лет, Самара - с. Красный Яр', 'Самара - с. Красный Яр, Россия'),
        ('John Doe, 30 лет, Букреево-Плессо', 'Букреево Плёсо, Россия'),
        ('John Doe, 30 лет, Москва Москва: Юго-Западный АО, ', 'Москва Москва: Юго-Западный АО,, Россия'),
        (
            'John Doe, 30 лет,  Луховицы - д.Алтухово, Зарайский городской округ,',
            'Луховицы - д.Алтухово, Зарайский городской округ,, Россия',
        ),
        ('John Doe, 30 лет, Сагкт-Петербург', 'Сагкт-Петербург, Россия'),
        ('John Doe, 30 лет, Краснозерский', 'Краснозерский, Россия'),
        ('John Doe, 30 лет, Толмачевское', 'Толмачевское, Россия'),
        ('John Doe, 30 лет, Кочевский', 'Кочевский, Россия'),
        ('John Doe, 30 лет, Чесцы', 'Чесцы, Россия'),
        ('John Doe, Чесцы', 'Чесцы, Россия'),
        ('John Doe, 30, Чесцы', 'Чесцы, Россия'),
