        ...
        for key, value in self.__dict__.items():
            ...
            if curr_button_is_in_existing_id_list:
                if not curr_button_is_asked_to_change:
                    keyboard += [
                        {"text": curr_button.on, 'callback_data': '{"action": "off"}'}]  # , "button": {curr_button.text}'}]

                else:
                    keyboard += [
                        {"text": curr_button.off, 'callback_data': '{"action": "off"}'}]
            else:
                if not curr_button_is_asked_to_change:
                    keyboard += [
                        {"text": curr_button.off, 'callback_data': '{"action": "off"}'}]
                    ...
                    keyboard += [
                        {"text": curr_button.on, 'callback_data': '{"action": "off"}'}]
