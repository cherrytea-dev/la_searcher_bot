    ...
    def match_type_to_pattern(pattern_type):
        ...
        if pattern_type == 'MISTYPE':
            ...
            patterns = [
                ...
                [r'Жив(?=[А-Я])', 'Стоп '],  # specific case for one search
            ...
            patterns = [
                ...
                [r'(?i)(^|\W)информации\W', 'СТОП ПРОВЕРКА ИНФО', 'search'],
            ...
            patterns = [
                r'(\W[\w-]{3,20}\W)?с\.п\..*',
                r'(?i)\W(дер\.|деревня|село|пос\.|урочище|ур\.|станица|хутор|пгт|аул|город\W|пос\W|улус\W|'
